...
import { Bell, Menu, X, Award, BookOpen, User, Home, Users, Brain, MessageSquare } from "lucide-react"
...
export default function Navbar() {
  ...
  const navItems = [
    ...
    // { href: "/sessions", label: "Sessions", icon: <Calendar className="h-4 w-4 mr-2" /> },
  ]
          ...
          <div className="container mx-auto px-4 space-y-1">
            ...
            <div className="pt-2 border-t border-gray-800">
              <div className="flex items-center px-3 py-2">
                <Avatar className="h-8 w-8 border-2 border-purple-500 mr-2">
                  <AvatarImage src="/placeholder.svg?height=32&width=32" alt="@username" />
                  <AvatarFallback className="bg-gray-700">UN</AvatarFallback>
                </Avatar>
                <div>
                  <div className="text-sm font-medium">Username</div>
                  <div className="text-xs text-gray-400">Rank B • 2450 XP</div>
                </div>
              </div>
            </div>
          </div>
